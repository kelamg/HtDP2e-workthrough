...
;;     Formulate it as an element of Lam. Does undeclareds work properly
;;     on your expression?

;; A - ((λ (y) (λ (x) (* x y))) x)
;;     -> (list (list 'λ (list 'y) (list 'λ (list 'x) (list '*undeclared 'x)))
;;              '*undeclared)
...
(check-expect (undeclareds ex5) '*undeclared)
