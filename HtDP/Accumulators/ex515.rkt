...
(define und-expr '(λ (*undeclared) ((λ (x) (x *undeclared)) y)))
...
(check-expect
 (undeclareds ex1) '(λ (x) *declared:x))
(check-expect
 (undeclareds ex2) '(λ (x) *undeclared:y))
(check-expect
 (undeclareds ex3) '(λ (y) (λ (x) *declared:y)))
(check-expect
 (undeclareds ex4)
 '((λ (x) (*declared:x *declared:x)) (λ (x) (*declared:x *declared:x))))
(check-expect (undeclareds ex5) '*undeclared:x)
