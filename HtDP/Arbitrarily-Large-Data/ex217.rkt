...
(define WORM-INIT W3)
;  (make-worm (make-posn (/ WIDTH 2) (/ HEIGHT 2))
;             '()
;             "r"))
...
;; its segments follow the head's movement
(check-expect
 (slither-worm W1)
...
(check-expect
 ...
 (place-image (text MSG TEXT-SIZE TEXT-COLOR)
              TEXT-X TEXT-Y
              (render-worm
